 ...
 * 그 뒤의 체력 곡선(1 → 42, 막 안 진행 1.55 포함 최대 65배)은 화력 140배의 일부만
 * 따라간다: 전부 상쇄하면 초당 수백 킬의 파워판타지가 죽는다. 42의 몫은 "군체는
 * 쓸리되 굵은 것(5막 Hex ≈ 3,000hp)은 화망 속에서 몇 초를 버티고 몸에 닿는다"까지다.
 * (한때 여기 적혔던 190/13,500hp 는 구조 수정 전의 시도값이다. 코드는 42로 내려갔는데
